...
function ajaxDocContent(){
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            alreadyDone = data.data.alreadyDone;//每段已经做了的信息抽取的值
            ...
            paintText(paraContent,entitydone);
